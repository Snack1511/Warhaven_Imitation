...
CAI_TG_Warrior_Attack_HorizontalMiddle_R::CAI_TG_Warrior_Attack_HorizontalMiddle_R()
{
}
...
CAI_TG_Warrior_Attack_HorizontalMiddle_R* CAI_TG_Warrior_Attack_HorizontalMiddle_R::Create()
{
	CAI_TG_Warrior_Attack_HorizontalMiddle_R* pInstance = new CAI_TG_Warrior_Attack_HorizontalMiddle_R();

	if (FAILED(pInstance->Initialize()))
	{
		Call_MsgBox(L"Failed to Initialize : CAI_TG_Warrior_Attack_HorizontalMiddle_R");
		SAFE_DELETE(pInstance);
	}

	return pInstance;
}
HRESULT CAI_TG_Warrior_Attack_HorizontalMiddle_R::Initialize()
{
	/* HIT_INFO */
	...
	m_eStateType = AI_STATE_ATTACK_HORIZONTALMIDDLE_R;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
STATE_TYPE CAI_TG_Warrior_Attack_HorizontalMiddle_R::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
	return __super::Tick(pOwner, pAnimator);
}

void CAI_TG_Warrior_Attack_HorizontalMiddle_R::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
...
STATE_TYPE CAI_TG_Warrior_Attack_HorizontalMiddle_R::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
...
void CAI_TG_Warrior_Attack_HorizontalMiddle_R::On_KeyFrameEvent(CUnit* pOwner, CAnimator* pAnimator, const KEYFRAME_EVENT& tKeyFrameEvent, _uint iSequence)
{
