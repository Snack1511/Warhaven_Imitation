...
CState_Patrol_Cure_Loop_Priest::CState_Patrol_Cure_Loop_Priest()
{
}
...
CState_Patrol_Cure_Loop_Priest* CState_Patrol_Cure_Loop_Priest::Create()
{
	CState_Patrol_Cure_Loop_Priest* pInstance = new CState_Patrol_Cure_Loop_Priest();

	if (FAILED(pInstance->Initialize()))
	{
		Call_MsgBox(L"Failed to Initialize : CState_Patrol_Cure_Loop_Priest");
...
HRESULT CState_Patrol_Cure_Loop_Priest::Initialize()
{
	m_eAnimType = ANIM_ATTACK;            // 애니메이션의 메쉬타입
	m_iAnimIndex = 6;                   // 현재 내가 사용하고 있는 애니메이션 순서(0 : IDLE, 1 : Run)
	m_eStateType = AI_STATE_PATROL_CURE_LOOP_PRIEST;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
void CState_Patrol_Cure_Loop_Priest::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevStateType, void* pData)
{
...
void CState_Patrol_Cure_Loop_Priest::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
...
STATE_TYPE CState_Patrol_Cure_Loop_Priest::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
