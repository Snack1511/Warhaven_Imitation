...
CValkyrie_Attack_HorizontalUp::CValkyrie_Attack_HorizontalUp()
{
}
...
HRESULT CValkyrie_Attack_HorizontalUp::Initialize()
{
...
void CValkyrie_Attack_HorizontalUp::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CValkyrie_Attack_HorizontalUp::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
	return __super::Tick(pOwner, pAnimator);
}

void CValkyrie_Attack_HorizontalUp::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
...
STATE_TYPE CValkyrie_Attack_HorizontalUp::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
    /* Player가 Walk로 오는 조건
    1. 위로 공격할 시 
	*/
...
void CValkyrie_Attack_HorizontalUp::On_KeyFrameEvent(CUnit * pOwner, CAnimator * pAnimator, const KEYFRAME_EVENT & tKeyFrameEvent, _uint iSequence)
{
