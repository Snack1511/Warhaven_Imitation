...
CAI_CWarrior_Attack_HorizontalMiddle_R::CAI_CWarrior_Attack_HorizontalMiddle_R()
{
}
...
CAI_CWarrior_Attack_HorizontalMiddle_R* CAI_CWarrior_Attack_HorizontalMiddle_R::Create()
{
	CAI_CWarrior_Attack_HorizontalMiddle_R* pInstance = new CAI_CWarrior_Attack_HorizontalMiddle_R();

	if (FAILED(pInstance->Initialize()))
	{
		Call_MsgBox(L"Failed to Initialize : CAI_CWarrior_Attack_HorizontalMiddle_R");
		SAFE_DELETE(pInstance);
	}

	return pInstance;
}
HRESULT CAI_CWarrior_Attack_HorizontalMiddle_R::Initialize()
{
	__super::Initialize();
	...
	m_eStateType = STATE_HORIZONTALMIDDLEATTACK_WARRIOR_R_AI_ENEMY;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
STATE_TYPE CAI_CWarrior_Attack_HorizontalMiddle_R::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
...
void CAI_CWarrior_Attack_HorizontalMiddle_R::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
	__super::Exit(pOwner, pAnimator);
}

STATE_TYPE CAI_CWarrior_Attack_HorizontalMiddle_R::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
	return __super::Check_Condition(pOwner, pAnimator);
}

void CAI_CWarrior_Attack_HorizontalMiddle_R::On_KeyFrameEvent(CUnit* pOwner, CAnimator* pAnimator, const KEYFRAME_EVENT& tKeyFrameEvent, _uint iSequence)
{
