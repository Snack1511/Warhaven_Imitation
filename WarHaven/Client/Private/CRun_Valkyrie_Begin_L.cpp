...
CRun_Valkyrie_Begin_L::CRun_Valkyrie_Begin_L()
{
}
...
CRun_Valkyrie_Begin_L* CRun_Valkyrie_Begin_L::Create()
{
    CRun_Valkyrie_Begin_L* pInstance = new CRun_Valkyrie_Begin_L();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CRun_Valkyrie_Begin_L");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CRun_Valkyrie_Begin_L::Initialize()
{
    __super::Initialize();
...
void CRun_Valkyrie_Begin_L::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CRun_Valkyrie_Begin_L::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
    if (KEY(SPACE, TAP))
    {
...
void CRun_Valkyrie_Begin_L::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
    /* 할거없음 */
}

STATE_TYPE CRun_Valkyrie_Begin_L::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
