...
CHit_Groggy_Archer::CHit_Groggy_Archer()
{
}
...
CHit_Groggy_Archer* CHit_Groggy_Archer::Create()
{
    CHit_Groggy_Archer* pInstance = new CHit_Groggy_Archer();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CHit_Groggy_Archer");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CHit_Groggy_Archer::Initialize()
{
...
void CHit_Groggy_Archer::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
	//pOwner->Enable_UnitCollider(CUnit::WEAPON_R, false);

}

STATE_TYPE CHit_Groggy_Archer::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
