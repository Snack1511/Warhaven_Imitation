...
CSprint_Jump_Archer::CSprint_Jump_Archer()
{
}
...
CSprint_Jump_Archer* CSprint_Jump_Archer::Create()
{
    CSprint_Jump_Archer* pInstance = new CSprint_Jump_Archer();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CSprint_Jump_Archer");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CSprint_Jump_Archer::Initialize()
{
...
void CSprint_Jump_Archer::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CSprint_Jump_Archer::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
	CTransform* pMyTransform = pOwner->Get_Transform();
	CPhysics* pMyPhysicsCom = pOwner->Get_PhysicsCom();
...
void CSprint_Jump_Archer::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
    /* 할거없음 */
}

STATE_TYPE CSprint_Jump_Archer::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
