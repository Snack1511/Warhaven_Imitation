...
CValkyrie_Attack_HorizontalDown_L::CValkyrie_Attack_HorizontalDown_L()
{
}
...
CValkyrie_Attack_HorizontalDown_L* CValkyrie_Attack_HorizontalDown_L::Create()
{
	CValkyrie_Attack_HorizontalDown_L* pInstance = new CValkyrie_Attack_HorizontalDown_L();

	if (FAILED(pInstance->Initialize()))
	{
		Call_MsgBox(L"Failed to Initialize : CValkyrie_Attack_HorizontalDown_L");
		SAFE_DELETE(pInstance);
	}

	return pInstance;
}
HRESULT CValkyrie_Attack_HorizontalDown_L::Initialize()
{
	...
	m_eStateType = STATE_ATTACK_HORIZONTALDOWN_VALKYRIE_L;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
void CValkyrie_Attack_HorizontalDown_L::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CValkyrie_Attack_HorizontalDown_L::Tick(CUnit* pOwner, CAnimator* pAnimator)
{

	return __super::Tick(pOwner, pAnimator);
}

void CValkyrie_Attack_HorizontalDown_L::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
	__super::Exit(pOwner, pAnimator);
}

STATE_TYPE CValkyrie_Attack_HorizontalDown_L::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
	return __super::Check_Condition(pOwner, pAnimator);
}

void CValkyrie_Attack_HorizontalDown_L::On_KeyFrameEvent(CUnit* pOwner, CAnimator* pAnimator, const KEYFRAME_EVENT& tKeyFrameEvent, _uint iSequence)
{
