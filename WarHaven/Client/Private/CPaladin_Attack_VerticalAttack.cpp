...
CPaladin_Attack_VerticalAttack::CPaladin_Attack_VerticalAttack()
{
}
...
CPaladin_Attack_VerticalAttack* CPaladin_Attack_VerticalAttack::Create()
{
	CPaladin_Attack_VerticalAttack* pInstance = new CPaladin_Attack_VerticalAttack();

	if (FAILED(pInstance->Initialize()))
	{
		Call_MsgBox(L"Failed to Initialize : CPaladin_Attack_VerticalAttack");
		SAFE_DELETE(pInstance);
	}

	return pInstance;
}
HRESULT CPaladin_Attack_VerticalAttack::Initialize()
{
...
void CPaladin_Attack_VerticalAttack::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CPaladin_Attack_VerticalAttack::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
	return __super::Tick(pOwner, pAnimator);
}

void CPaladin_Attack_VerticalAttack::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
	pOwner->Enable_UnitCollider(CUnit::WEAPON_R, false);
	__super::Exit(pOwner, pAnimator);
}

STATE_TYPE CPaladin_Attack_VerticalAttack::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
...
void CPaladin_Attack_VerticalAttack::On_KeyFrameEvent(CUnit* pOwner, CAnimator* pAnimator, const KEYFRAME_EVENT& tKeyFrameEvent, _uint iSequence)
{
