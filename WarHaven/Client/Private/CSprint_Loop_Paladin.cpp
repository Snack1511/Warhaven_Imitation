...
CSprint_Loop_Paladin::CSprint_Loop_Paladin()
{
}
...
CSprint_Loop_Paladin* CSprint_Loop_Paladin::Create()
{
    CSprint_Loop_Paladin* pInstance = new CSprint_Loop_Paladin();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CSprint_Loop_Paladin");
...
void CSprint_Loop_Paladin::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
    if (ePrevType == STATE_SPRINT_BEGIN_PALADIN || ePrevType == STATE_SPRINT_LOOP_PALADIN)
        m_fInterPolationTime = 0.f;
...
STATE_TYPE CSprint_Loop_Paladin::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
    if (pOwner->Is_Air())
...
void CSprint_Loop_Paladin::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
	CPhysics* pMyPhysicsCom = pOwner->Get_PhysicsCom();
...
STATE_TYPE CSprint_Loop_Paladin::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
