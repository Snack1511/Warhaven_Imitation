...
wstring CUI_MainPlay::m_wstrModeText = TEXT("맵 - 훈련소");
...
void CUI_MainPlay::Create_StageBtn()
{
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		if (i == 0)
		{
			...
			m_pStageSelectBtn[i]->Set_FontText(TEXT("파덴"));
