...
CState_PathNavigation_Sprint_Archer_End::CState_PathNavigation_Sprint_Archer_End()
{
}
...
CState_PathNavigation_Sprint_Archer_End* CState_PathNavigation_Sprint_Archer_End::Create()
{
    CState_PathNavigation_Sprint_Archer_End* pInstance = new CState_PathNavigation_Sprint_Archer_End();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CState_PathNavigation_Sprint_Archer_End");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CState_PathNavigation_Sprint_Archer_End::Initialize()
{
    ...
    m_eStateType = AI_STATE_PATHNAVIGATION_SPRINTEND_ARCHER;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
void CState_PathNavigation_Sprint_Archer_End::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData)
{
...
STATE_TYPE CState_PathNavigation_Sprint_Archer_End::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
