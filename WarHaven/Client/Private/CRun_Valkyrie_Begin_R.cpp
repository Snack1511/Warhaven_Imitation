...
CRun_Valkyrie_Begin_R::CRun_Valkyrie_Begin_R()
{
}
...
CRun_Valkyrie_Begin_R* CRun_Valkyrie_Begin_R::Create()
{
    CRun_Valkyrie_Begin_R* pInstance = new CRun_Valkyrie_Begin_R();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CRun_Valkyrie_Begin_R");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CRun_Valkyrie_Begin_R::Initialize()
{
    __super::Initialize();
...
void CRun_Valkyrie_Begin_R::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
...
STATE_TYPE CRun_Valkyrie_Begin_R::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
    if (KEY(SPACE, TAP))
    {
...
void CRun_Valkyrie_Begin_R::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
    /* 할거없음 */
}

STATE_TYPE CRun_Valkyrie_Begin_R::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
