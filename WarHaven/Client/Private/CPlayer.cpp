...
{/*
	...
	wstring wstrModeSkel[CLASS_DEFAULT_END] = {
		...
		L"../bin/resources/meshes/characters/Warrior/Warrior.fbx", // SPEAR
		L"../bin/resources/meshes/characters/Warrior/Warrior.fbx", // ARCHER
		L"../bin/resources/meshes/characters/Warrior/Warrior.fbx", // Priest
		L"../bin/resources/meshes/characters/Warrior/Warrior.fbx", // PRIEST
		L"../bin/resources/meshes/characters/Warrior/Warrior.fbx" // ENGINEER
	};

	wstring wstrModeBody[CLASS_DEFAULT_END] = {
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx", // WARRIOR
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx", // SPEAR
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx", // ARCHER
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx", // Priest
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx", // PRIEST
		L"../bin/resources/meshes/characters/Warrior/body/SK_Warrior0001_Body_A00.fbx"  // ENGINEER
	};

	wstring wstrModeFace[CLASS_DEFAULT_END] = {
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx", // WARRIOR
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx", // SPEAR
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx", // ARCHER
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx", // Priest
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx", // PRIEST
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0001_Face_A00.fbx" // ENGINEER
	};
	...
	wstring wstrModeHead[CLASS_DEFAULT_END] = {
		...
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0002_Helmet_A00.fbx", // SPEAR
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0002_Helmet_A00.fbx", // ARCHER
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0002_Helmet_A00.fbx", // Priest
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0002_Helmet_A00.fbx", // PRIEST
		L"../bin/resources/meshes/characters/Warrior/Head/SK_Warrior0002_Helmet_A00.fbx"// ENGINEER
	};

	wstring wstrModeWeapon_R[CLASS_DEFAULT_END] = {
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // WARRIOR
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // SPEAR
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // ARCHER
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // Priest
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // PRIEST
		L"../bin/resources/meshes/weapons/LongSword/SM_WP_LongSword0001_A00.fbx", // ENGINEER
	};
	...
	m_pDefaultClass[CLASS_DEFAULT_SPEAR] = m_pDefaultClass[CLASS_DEFAULT_WARRIOR];
	m_pDefaultClass[CLASS_DEFAULT_ARCHER] = m_pDefaultClass[CLASS_DEFAULT_WARRIOR];
	m_pDefaultClass[CLASS_DEFAULT_PALADIN] = m_pDefaultClass[CLASS_DEFAULT_WARRIOR];
	m_pDefaultClass[CLASS_DEFAULT_PRIEST] = m_pDefaultClass[CLASS_DEFAULT_WARRIOR];
	m_pDefaultClass[CLASS_DEFAULT_ENGINEER] = m_pDefaultClass[CLASS_DEFAULT_WARRIOR];
	...
	for (int i = 0; i < CLASS_DEFAULT_END; ++i)
	{
		...
		else
		{
			...
			m_pDefaultClass[i]->SetUp_Colliders(true);
			m_pDefaultClass[i]->SetUp_HitStates(true);
...
HRESULT CPlayer::Set_FollowCam(wstring wstrCamKey)
{
	...
	CREATE_STATIC(m_pFollowCam, HASHCODE(CCamera_Follow));
...
HRESULT CPlayer::Initialize_Prototype(wstring wstrCamKey, CLASS_DEFAULT eClass)
{
	...
	m_pCurrentUnit = m_pDefaultClass[eClass];
	m_pFollowCam = (CCamera_Follow*)GAMEINSTANCE->Find_Camera(wstrCamKey);
	m_pFollowCam->Set_FollowTarget(m_pCurrentUnit);
