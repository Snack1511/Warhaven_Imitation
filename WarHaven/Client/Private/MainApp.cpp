...
void CMainApp::Col_Check()
{
	...
	GAMEINSTANCE->Check_Group(COL_PROJECTILECATCH, COL_BLUEATTACK);
	GAMEINSTANCE->Check_Group(COL_PROJECTILECATCH, COL_BLUEGUARDBREAK);
	GAMEINSTANCE->Check_Group(COL_PROJECTILECATCH, COL_BLUEGROGGYATTACK);
	GAMEINSTANCE->Check_Group(COL_PROJECTILECATCH, COL_BLUEFLYATTACK);
	GAMEINSTANCE->Check_Group(COL_PROJECTILECATCH, COL_BLUEFLYATTACKGUARDBREAK);
