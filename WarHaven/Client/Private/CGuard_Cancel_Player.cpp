...
HRESULT CGuard_Cancel_Player::Initialize()
{
	...
	m_eStateType = STATE_GUARD_CANCEL_PLAYER;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
void CGuard_Cancel_Player::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData)
{
