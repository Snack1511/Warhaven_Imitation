...
CState_Common_FlyHit_Warrior::CState_Common_FlyHit_Warrior()
{
}
...
CState_Common_FlyHit_Warrior* CState_Common_FlyHit_Warrior::Create()
{
    CState_Common_FlyHit_Warrior* pInstance = new CState_Common_FlyHit_Warrior();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CState_Common_FlyHit_Warrior");
...
HRESULT CState_Common_FlyHit_Warrior::Initialize()
{
    ...
    m_eStateType = AI_STATE_COMMON_FLYHIT_WARRIOR;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
void CState_Common_FlyHit_Warrior::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData)
{
