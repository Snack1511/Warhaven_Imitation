...
HRESULT CRun_SpearMan_R::Initialize()
{
    ...
    m_eStateType = STATE_RUN_SPEARMAN_R;   // 나의 행동 타입(Init 이면 내가 시작할 타입)
...
//_bool CRun_SpearMan_R::Change_Animation_Run(_uint iBeginAttackAnim, _uint iAttackAnim, CAnimator* pAnimator)
//{
//    // RunBegin 
