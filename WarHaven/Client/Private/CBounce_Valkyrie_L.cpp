...
CBounce_Valkyrie_L::CBounce_Valkyrie_L()
{
}
...
CBounce_Valkyrie_L* CBounce_Valkyrie_L::Create()
{
    CBounce_Valkyrie_L* pInstance = new CBounce_Valkyrie_L();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CBounce_Valkyrie_L");
        SAFE_DELETE(pInstance);
    }

    return pInstance;
}
HRESULT CBounce_Valkyrie_L::Initialize()
{
	__super::Initialize();
...
void CBounce_Valkyrie_L::Enter(CUnit* pOwner, CAnimator* pAnimator, STATE_TYPE ePrevType, void* pData )
{
    /* Owner의 Animator Set Idle로 */
    __super::Enter(pOwner, pAnimator, ePrevType, pData);
}

STATE_TYPE CBounce_Valkyrie_L::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
    return __super::Tick(pOwner, pAnimator);
}

void CBounce_Valkyrie_L::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
    /* 할거없음 */
}

STATE_TYPE CBounce_Valkyrie_L::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
