...
CAI_SandBack_FlyHit::CAI_SandBack_FlyHit()
{
}
...
CAI_SandBack_FlyHit* CAI_SandBack_FlyHit::Create()
{
    CAI_SandBack_FlyHit* pInstance = new CAI_SandBack_FlyHit();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CAI_SandBack_FlyHit");
...
HRESULT CAI_SandBack_FlyHit::Initialize()
{
...
void CAI_SandBack_FlyHit::Exit(CUnit* pOwner, CAnimator* pAnimator)
{

}

STATE_TYPE CAI_SandBack_FlyHit::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
    /* Player가 Idle로 오는 조건
