...
BEGIN(Client)
class CPriest_Cure_Loop 
	: public CState
{
	DECLARE_STATE(CPriest_Cure_Loop);
...
private:
	CPriest_Cure_Loop();
	virtual ~CPriest_Cure_Loop();


public:
	static CPriest_Cure_Loop* Create();
...
private:
	...
	CUnit* m_pPrvUnit = nullptr;
	CUnit* m_pCurUnit = nullptr;
