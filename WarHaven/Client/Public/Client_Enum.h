...
namespace Client
{
	...
	enum VTXTEX_PASS_TYPE
	{
		...
		VTXTEX_PASS_UI_StrongHoldGauge,
...
#pragma region AI_Warrior_Behavior
			AI_STATE_DEAFULT_IDLE_WARRIOR_L,
			AI_STATE_DEAFULT_IDLE_WARRIOR_R,
			AI_STATE_DEAFULT_SWITCH_R_TO_L,
			AI_STATE_DEAFULT_SWITCH_L_TO_R,
			AI_STATE_DEAFULT_WALK_WARRIOR_L,
			AI_STATE_DEAFULT_WALK_WARRIOR_R,

			AI_STATE_COMBAT_RUN_WARRIOR_L,
			AI_STATE_COMBAT_RUN_WARRIOR_R,


			//AI_STATE_COMBAT_BEGIN_WARRIOR,
			//AI_STATE_COMBAT_LOOP_WARRIOR,
			//AI_STATE_COMBAT_CANCEL_WARRIOR,
			//AI_STATE_COMBAT_END_WARRIOR,
