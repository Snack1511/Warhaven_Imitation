...
#pragma region AI_Engineer_Behavior
		AI_STATE_PATROL_DEAFULT_ENGINEER_L,
		AI_STATE_PATROL_DEAFULT_ENGINEER_R,
		...
		AI_STATE_COMBAT_DEAFULT_ENGINEER_L,
		AI_STATE_COMBAT_DEAFULT_ENGINEER_R,
...
#pragma region AI_Fiona_Behavior
		AI_STATE_PATROL_DEAFULT_FIONA_L,
		AI_STATE_PATROL_DEAFULT_FIONA_R,
		...
		AI_STATE_COMBAT_DEAFULT_FIONA_L,
		AI_STATE_COMBAT_DEAFULT_FIONA_R,
...
#pragma region AI_Paladin_Behavior
			...
			AI_STATE_PATROL_DEAFULT_PALADIN_L,
			AI_STATE_PATROL_DEAFULT_PALADIN_R,
			...
			AI_STATE_COMBAT_DEAFULT_PALADIN_L,
			AI_STATE_COMBAT_DEAFULT_PALADIN_R,
