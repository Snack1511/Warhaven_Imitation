...
#pragma region AI_Archer_Behavior
			...
			//AI_STATE_COMBAT_HORIZONTALMIDDLE_ARCHER_L,
			//AI_STATE_COMBAT_HORIZONTALMIDDLE_ARCHER_R,
			//AI_STATE_COMBAT_VERTICALCUT_ARCHER,

			//AI_STATE_COMBAT_SHIELDWALL_BEGIN_ARCHER,
			//AI_STATE_COMBAT_SHIELDWALL_LOOP_ARCHER,
			//AI_STATE_COMBAT_SHIELDWALL_END_ARCHER,
			//AI_STATE_COMBAT_SHIELDWALL_HIT_ARCHER,

			//AI_STATE_COMBAT_RUSH_BEGIN_ARCHER,
			//AI_STATE_COMBAT_RUSH_LOOP_ARCHER,
			//AI_STATE_COMBAT_RUSH_END_ARCHER,

			//AI_STATE_COMBAT_SHIELDSLAM_ARCHER,


			//AI_STATE_COMBAT_GUARDBEGIN_ARCHER,
			//AI_STATE_COMBAT_GUARDLOOP_ARCHER,
			//AI_STATE_COMBAT_GUARDEND_ARCHER,
			//AI_STATE_COMBAT_GUARDCANCEL_ARCHER,
