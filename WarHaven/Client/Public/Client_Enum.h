...
namespace Client
{
	...
	enum VTXTEX_PASS_TYPE
	{
		...
		VTXTEX_PASS_UI_HwaraArrow,
		VTXTEX_PASS_UI_HwaraGlowLine,
...
#pragma region AI_Warrior_Behavior
		...
		AI_STATE_PATHNAVIGATION_FALL_WARRIOR_L,
		AI_STATE_PATHNAVIGATION_FALL_WARRIOR_R,
...
#pragma region AI_Engineer_Behavior
		...
		AI_STATE_PATHNAVIGATION_FALL_ENGINEER_L,
		AI_STATE_PATHNAVIGATION_FALL_ENGINEER_R,
...
#pragma region AI_Fiona_Behavior
		...
		AI_STATE_PATHNAVIGATION_FALL_FIONA_L,
		AI_STATE_PATHNAVIGATION_FALL_FIONA_R,
...
#pragma region AI_Paladin_Behavior
		...
		AI_STATE_PATHNAVIGATION_FALL_PALADIN_L,
		AI_STATE_PATHNAVIGATION_FALL_PALADIN_R,
...
#pragma region AI_Archer_Behavior
		...
		AI_STATE_PATHNAVIGATION_FALL_ARCHER_L,
		AI_STATE_PATHNAVIGATION_FALL_ARCHER_R,
...
#pragma region AI_Priest_Behavior

		AI_STATE_PATROL_DEFAULT_PRIEST,
		AI_STATE_PATROL_WALK_PRIEST,
		AI_STATE_PATROL_CURE_BEGIN_PRIEST,
		AI_STATE_PATROL_CURE_LOOP_PRIEST,
		AI_STATE_PATROL_CURE_END_PRIEST,

		AI_STATE_COMBAT_DEFAULT_PRIEST,
		AI_STATE_COMBAT_STINGATTACK_PRIEST,

		AI_STATE_COMBAT_CURE_BEGIN_PRIEST,
		AI_STATE_COMBAT_CURE_LOOP_PRIEST,
		AI_STATE_COMBAT_CURE_END_PRIEST,

		AI_STATE_COMBAT_CATCH_BEGIN_PRIEST,
		AI_STATE_COMBAT_CATCH_LOOP_PRIEST,
		AI_STATE_COMBAT_CATCHING_PRIEST,
		AI_STATE_COMBAT_CATCH_SHOOT_PRIEST,

		AI_STATE_COMBAT_WINDATTACK_PRIEST,
		AI_STATE_COMBAT_AIRDASH_PRIEST,

		AI_STATE_PATHNAVIGATION_DEFAULT_PRIEST,
		AI_STATE_PATHNAVIGATION_WALK_PRIEST,
		AI_STATE_PATHNAVIGATION_SPRINTBEGIN_PRIEST,
		AI_STATE_PATHNAVIGATION_SPRINTLOOP_PRIEST,
		AI_STATE_PATHNAVIGATION_SPRINTEND_PRIEST,
		AI_STATE_PATHNAVIGATION_SPRINTJUMP_PRIEST,
		AI_STATE_PATHNAVIGATION_SPRINTJUMPFALL_PRIEST,
		AI_STATE_PATHNAVIGATION_JUMP_PRIEST,
		AI_STATE_PATHNAVIGATION_FALL_PRIEST,


		AI_STATE_COMMON_BOUNCE_PRIEST,
		AI_STATE_COMMON_HIT_PRIEST,
		AI_STATE_COMMON_GROGGYHIT_PRIEST,
		AI_STATE_COMMON_STINGHIT_PRIEST,
		AI_STATE_COMMON_FLYHIT_PRIEST,
		AI_STATE_COMMON_FALL_PRIEST,
		AI_STATE_COMMON_LAND_PRIEST,

		AI_STATE_CATCH_CANNON_BEGIN_PRIEST,
		AI_STATE_CATCH_CANNON_LOOP_PRIEST,
		AI_STATE_CATCH_CANNON_PRIEST,
		AI_STATE_CATCH_CANNON_SHOOT_PRIEST,

#pragma endregion

#pragma region AI_Qanda_Behavior

		AI_STATE_PATROL_DEFAULT_QANDA,
		AI_STATE_PATROL_WALK_QANDA,


		AI_STATE_COMBAT_DEAFULT_QANDA,

		AI_STATE_COMBAT_BEGIN_QANDA,
		AI_STATE_COMBAT_AIMING_QANDA,
		AI_STATE_COMBAT_SHOOT_QANDA,

		AI_STATE_COMBAT_BEGIN_SNIPING_QANDA,
		AI_STATE_COMBAT_AIMING_SNIPING_QANDA,
		AI_STATE_COMBAT_SHOOT_SNIPING_QANDA,

		AI_STATE_COMBAT_SHADOWSTEP_QANDA,
		AI_STATE_COMBAT_GUARD_QANDA,


		AI_STATE_PATHNAVIGATION_DEFAULT_QANDA,
		AI_STATE_PATHNAVIGATION_WALK_QANDA,
		AI_STATE_PATHNAVIGATION_SPRINTBEGIN_QANDA,
		AI_STATE_PATHNAVIGATION_SPRINTLOOP_QANDA,
		AI_STATE_PATHNAVIGATION_SPRINTEND_QANDA,
		AI_STATE_PATHNAVIGATION_SPRINTJUMP_QANDA,
		AI_STATE_PATHNAVIGATION_SPRINTJUMPFALL_QANDA,
		AI_STATE_PATHNAVIGATION_JUMP_QANDA,
		AI_STATE_PATHNAVIGATION_FALL_QANDA,

		AI_STATE_COMMON_HIT_QANDA,
		AI_STATE_COMMON_GUARDHIT_QANDA,
		AI_STATE_COMMON_GROGGYHIT_QANDA,
		AI_STATE_COMMON_STINGHIT_QANDA,
		AI_STATE_COMMON_FLYHIT_QANDA,
		AI_STATE_COMMON_FALL_QANDA,
		AI_STATE_COMMON_LAND_QANDA,
		AI_STATE_COMMON_GUARD_CANCEL_QANDA,


#pragma endregion

#pragma region AI_Lancer_Behavior

		AI_STATE_PATROL_DEFAULT_LANCER,
		AI_STATE_PATROL_WALK_LANCER,

		AI_STATE_COMBAT_DEAFULT_LANCER,
		AI_STATE_COMBAT_ATTACKSWING_LANCER,
		AI_STATE_COMBAT_STING_LANCER,
		AI_STATE_COMBAT_BREEZE_BEGIN_LANCER,
		AI_STATE_COMBAT_BREEZE_LOOP_LANCER,
		AI_STATE_COMBAT_STOP_LANCER,

		AI_STATE_PATHNAVIGATION_DEFAULT_LANCER,
		AI_STATE_PATHNAVIGATION_JUMP_LANCER,
		AI_STATE_PATHNAVIGATION_STOP_LANCER,

		
		AI_STATE_COMMON_BOUNCE_LANCER,
		AI_STATE_COMMON_HIT_LANCER,
		AI_STATE_COMMON_GROGGYHIT_LANCER,
		AI_STATE_COMMON_FLYHIT_LANCER,
		AI_STATE_COMMON_FALL_LANCER,
		AI_STATE_COMMON_LAND_LANCER,
